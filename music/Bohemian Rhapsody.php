  ...
  <header>
    ...
    <nav>
      <ul>
        ...
        <li><a href="">Bohemian Rhapsody</a></li>
      </ul>
    </nav>
  </header>
  <article>
    <h1>video</video></h1>
      <iframe src="//player.bilibili.com/player.html?aid=24160391&bvid=BV12W411P7h1&cid=40491036&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
  </article>
</body>
</html>