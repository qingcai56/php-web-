  ...
  <header>
    ...
    <nav>
      <ul>
        ...
        <li><a href="">Sweet Child O' Mine</a></li>
      </ul>
    </nav>
  </header>
  <article>
    <h1>video</video></h1>
    <iframe src="//player.bilibili.com/player.html?aid=23634078&bvid=BV1Cp411d7eJ&cid=39467024&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
  </article>
