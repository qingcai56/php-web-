...
<body>
  <header>
    ...
    <nav>
      <ul>
        <li><a href="../video.php">return</a></li>
        <li><a href="">We Will Rock You+We Are The Champion</a></li>
      </ul>
    </nav>
  </header>
  <article>
    <h1>video</video></h1>
    <iframe src="//player.bilibili.com/player.html?aid=49603614&bvid=BV1Eb41157YV&cid=86852706&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
  </article>
